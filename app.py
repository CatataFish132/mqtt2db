...
def iot_send_message(device_id="PI", temperature=-127, humidity=-1, pressure=-1, date_created=datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'), callback=send_confirmation_callback, ID=0):
    try:
